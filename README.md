...
完整参数文档见 [Reference](./docs/Reference.md) 或 [在线文档](https://py-img-processor.readthedocs.io/)。
...
> **Note**: `PROCESSOR_TEXT_FONT` 是文字水印的必要前提——请确保系统已安装该字体，或直接设置为字体文件路径。默认值 `Arial Unicode.ttf` 仅在 macOS 可用。
